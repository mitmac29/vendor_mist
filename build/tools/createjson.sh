...
# Copyright (C) 2024 MistOS Android Project
#
...
#$1=TARGET_DEVICE, $2=PRODUCT_OUT, $3=FILE_NAME, $4=MIST_VERSION_BASE, $5=MIST_CODENAME, $6=MIST_PACKAGE_TYPE, $7=MIST_RELEASE_TYPE
